...
def retrieval_node(state) -> dict:
    ...
    try:
        # Task 1 hardening: every tool call gets a hard wall-clock timeout
        # rather than running unbounded. See hardening.py for why.
        result = run_with_timeout(tool.invoke, args)
